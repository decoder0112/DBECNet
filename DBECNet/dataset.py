...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, file_root='../home/ww/sq/DGMA3/data/LEVIR-cd256', transform=None):
        """
    ...
    def __getitem__(self, idx):
        pre_image_name = self.pre_images[idx]    ####B
        label_name = self.gts[idx]                ####label
        post_image_name = self.post_images[idx]   ###A
